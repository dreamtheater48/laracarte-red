...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <p class="alert alert-warning">
                <strong><i class="fas fa-exclamation-triangle"></i>This app has been built by <a href="https://twitter.com/etsmo"> @etsmo</a> for learning pruposes.</strong>            
            </p>
        </div>    
    </div>
    ...
    <h2>Which tools and services are uses in  Laracarte?</h2>
    ...
    <ul>
        ...
        <li>Google Maps</li>
        <li>Gravatar</li>
        <li>Antony's Martin geolocalisation Package</li>
